...
'''
class Network_2(NetworkBase):  # inherit from base class torch.nn.Module
    def __init__(self, save_dir, num_classes):
        super(Network_2, self).__init__(save_dir, num_classes)  # initialize Module characteristics
