...
class VGG16(nn.Module):  # inherit from base class torch.nn.Module
    def __init__(self, save_dir):
        ...
        self.conv3_1_64 = nn.Conv2d(3, 64, kernel_size=3, stride = 1, padding = 1)
        self.conv3_2_64 = nn.Conv2d(64, 64, kernel_size=3, stride = 1, padding = 1)
        ...
        self.conv3_1_128 = nn.Conv2d(64, 128, kernel_size=3, stride = 1, padding = 1)
        self.conv3_2_128 = nn.Conv2d(128, 128, kernel_size=3, stride = 1, padding = 1)
        ...
        self.conv3_1_256 = nn.Conv2d(128, 256, kernel_size=3, stride = 1, padding = 1)
        self.conv3_2_256 = nn.Conv2d(256, 256, kernel_size=3, stride = 1, padding = 1)
        self.conv3_3_256 = nn.Conv2d(256, 256, kernel_size=3, stride = 1, padding = 1)
        ...
        self.conv3_1_512 = nn.Conv2d(256, 512, kernel_size=3, stride = 1, padding = 1)
        self.conv3_2_512 = nn.Conv2d(512, 512, kernel_size=3, stride = 1, padding = 1)
        self.conv3_3_512 = nn.Conv2d(512, 512, kernel_size=3, stride = 1, padding = 1)
        ...
        self.conv3_4_512 = nn.Conv2d(512, 512, kernel_size=3, stride = 1, padding = 1)
        self.conv3_5_512 = nn.Conv2d(512, 512, kernel_size=3, stride = 1, padding = 1)
        self.conv3_6_512 = nn.Conv2d(512, 512, kernel_size=3, stride = 1, padding = 1)
        ...
        self.reduction_layer_1 = nn.Conv2d(512, 64, kernel_size = 1, stride = 1)
        self.reduction_layer_2 = nn.Conv2d(512, 64, kernel_size = 1, stride = 1)
        self.reduction_layer_3 = nn.Conv2d(256, 64, kernel_size = 1, stride = 1)
        self.reduction_layer_4 = nn.Conv2d(128, 64, kernel_size = 1, stride = 1)
        ...
        self.classify_layer = nn.Conv2d(128, 3, kernel_size = 1, stride = 1)
    ...
    def forward(self, x):
        ...
        for index, reduction_layer in enumerate(self.reduction_layers):
            x_prev = F.relu(reduction_layer(self.section_outputs[-index-2]))
