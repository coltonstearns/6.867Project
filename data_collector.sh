...
python3 training_main.py --save-to models/network4/FinalTrainedCRFandPrior -c --two_class --per_class --test --use_crf --prior -l models/network4/FinalTrained 
# Model 5 training
...
python3 training_main.py --save-to models/network5/FinalTrainedCRFandPrior -c --two_class --per_class --test --use_crf --prior -l models/network5/FinalTrained 
...
#python3 training_main.py --save-to models/network6/FinalTrainedReg -c --two_class --per_class

#Regularized Model 5 testing
#python3 training_main.py --save-to models/network6/FinalTrainedRegPlainTest -c --two_class --per_class --test -l models/network6/FinalTrainedReg
#python3 training_main.py --save-to models/network6/FinalTrainedRegPrior -c --two_class --per_class --test --prior  -l models/network6/FinalTrainedReg
