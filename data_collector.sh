...
python3 training_main.py --save-to models/network2/FinalTrainedPrior -c --two_class --per_class --test --pior -l models/network2/FinalTrained 
...
python3 training_main.py --save-to models/network3/FinalTrainedPrior -c --two_class --per_class --test --pior -l models/network3/FinalTrained 
